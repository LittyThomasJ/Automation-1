...
class CustomDate(unittest.TestCase, BaseTest):
    """ For testing all tests within billing custom date testcases
    ...
    def test_field_name(self, logger):
        self.field_name('custom_date_field_name', logger)
        # section_data_name = self.get_section_data('custom_date_field_name')
    ...
    def test_field_label(self, logger):
        self.field_label('custom_date_field_label', logger, section_type=self.section_type, action_type=self.action_type)

        # section_data_label = self.get_section_data('custom_date_field_label')
    ...
    def test_field_default_value(self, logger):
        ...
        section_data_default_value = self.get_section_data('custom_date_field_default_value')
    ...
    def test_field_class(self, logger):
        ...
        section_data_field_class = self.get_section_data('custom_date_field_class')
    ...
    def test_required(self, logger):
        ...
        section_data_required = self.get_section_data('custom_date_required')
    ...
    def test_enable_field(self, logger):
        ...
        section_data_enable_field = self.get_section_data('custom_date_enable_field')
    ...
    def test_display_order(self, logger):
        ...
        section_data_display_order = self.get_section_data('custom_date_display_order')
    ...
    def test_create_field(self, logger):
        ...
        section_data_label = self.get_section_data('custom_date_create_field')
        for label in section_data_label:
    ...
    def tearDownClass(cls):
        print("Billing Custom Date Completed")
        cls.driver.close()
        cls.driver.quit()
