...
class BillingCustomNumber(unittest.TestCase, BaseTest):
    """ For testing all tests within billing custom number testcases
    ...
    def test_field_name(self, logger):
        self.field_name('billing_custom_number_field_name', logger)
        # section_data_name = self.get_section_data('billing_custom_number_field_name')
    ...
    def test_field_label(self, logger):
        self.field_label('billing_custom_number_field_label', logger, section_type=self.section_type, action_type=self.action_type)

        # section_data_label = self.get_section_data('billing_custom_number_field_label')
    ...
    def test_field_placeholder(self, logger):
        ...
        section_data_placeholder = self.get_section_data('billing_custom_number_field_placeholder')
    ...
    def test_field_default_value(self, logger):
        ...
        section_data_default_value = self.get_section_data('billing_custom_number_field_default_value')
        for default_values in section_data_default_value:
            ...
            field_type = self.obj_base_page.clean_data(default_values['custom_field_type'])
    ...
    def test_field_class(self, logger):
        ...
        section_data_field_class = self.get_section_data('billing_custom_number_field_class')
    ...
    def test_required(self, logger):
        ...
        section_data_required = self.get_section_data('billing_custom_number_required')
    ...
    def test_enable_field(self, logger):
        ...
        section_data_enable_field = self.get_section_data('billing_custom_number_enable_field')
    ...
    def test_display_order(self, logger):
        ...
        section_data_display_order = self.get_section_data('billing_custom_number_display_order')
    ...
    def test_number_validation(self, logger):
        ...
        section_data_number_val = self.get_section_data('billing_custom_multiselect_create_field')
    ...
    def test_create_field(self, logger):
        ...
        section_data_label = self.get_section_data('billing_custom_number_create_field')
        for label in section_data_label:
