...
class ShippingCompany(unittest.TestCase, BaseTest):
    ...
    def test_field_label(self, logger):
        self.field_label('shipping_company_field_label', logger, section_type=self.section_type, action_type=self.action_type, row=self.row, field_name=self.field_name)

        # section_data_label = self.get_section_data('shipping_company_field_label')
    ...
    def test_field_placeholder(self, logger):
        ...
        section_data_placeholder = self.get_section_data('shipping_company_field_placeholder')
    ...
    def test_field_default_value(self, logger):
        ...
        section_data_default_value = self.get_section_data('shipping_company_field_default_value')
    ...
    def test_field_class(self, logger):
        ...
        section_data_field_class = self.get_section_data('shipping_company_field_class')
        for field_class in section_data_field_class:
            field_class_value = field_class['custom_field_class']
    ...
    def test_required(self, logger):
        ...
        section_data_required = self.get_section_data('shipping_company_required')
    ...
    def test_enable_field(self, logger):
        ...
        section_data_enable_field = self.get_section_data('shipping_company_enable_field')
    ...
    def test_edit_field(self, logger):
        ...
        section_data_label = self.get_section_data('shipping_company_edit_field')
        for label in section_data_label:
    ...
    def tearDownClass(cls):
        print("Shipping company Completed")
        cls.driver.close()
        cls.driver.quit()
